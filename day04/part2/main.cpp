...
size_t get_last_board(const std::vector<size_t> &numbers, std::vector<std::vector<std::vector<BingoNumber>>> &boards)
{
...
int main(int ac, char **av)
{
    ...
    size_t final_number = get_last_board(numbers, boards);
    std::cout << get_board_unchecked_sum(boards[0]) * final_number << std::endl;
